 ...
 * Supports: uuid-lab generate uuid  --count 5
 *           uuid-lab decode <id>
 *           uuid-lab scan <id>
 ...
 * @param {object} uid     - the uuid-lab module
 */
...
function generateTypeScript(schemaDef) {
  ...
  return [
    `/** Auto-generated by uuid-lab docgen */`,
...
function generateDocs(schemas, opts = {}) {
  const { format = 'markdown', title = 'uuid-lab Schema Reference' } = opts;
